...
<main id="main" class="xevos-main xevos-main--glows">
	...
	<?php endif; ?>
		...
		<!-- 3. Postup testování -->
		<?php
		$postup_heading = get_field('on_postup_heading') ?: '';
		$postup_text    = get_field('on_postup_text') ?: '';
		$kroky          = get_field('on_postup_kroky') ?: [];
		?>
		<?php if ( get_field('on_postup_zobrazit') !== false && ( $postup_heading || $postup_text || ! empty( $kroky ) ) ) : ?>
		...
		<!-- 4. Co získáte / Pro koho -->
		<?php
		$ziskate_heading   = get_field('on_ziskate_heading') ?: '';
		$ziskate_text      = get_field('on_ziskate_text') ?: '';
		$ziskate_seznam    = get_field('on_ziskate_seznam') ?: [];
		$prokoho_heading   = get_field('on_prokoho_heading') ?: '';
		$prokoho_text      = get_field('on_prokoho_text') ?: '';
		$prokoho_seznam    = get_field('on_prokoho_seznam') ?: [];
		$benefity_cta_text = get_field('on_benefity_cta_text') ?: '';
		...
		$show_benefity = get_field('on_benefity_zobrazit') !== false && ( $has_ziskate || $has_prokoho );
		?>
	...
	<!-- 5. Banner -->
	<?php
	$banner_heading  = get_field('on_banner_heading') ?: '';
	$banner_text     = get_field('on_banner_text') ?: '';
	...
	<?php if (get_field('on_formular_zobrazit') !== false) : ?>
		<?php
		$form_heading = get_field('on_formular_heading') ?: '';
		$form_text    = get_field('on_formular_text') ?: '';
		?>
