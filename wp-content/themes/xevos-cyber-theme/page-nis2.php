...
<main id="main" class="xevos-main xevos-main--glows">
	...
	if ($_show !== '0' && $_show !== 0) :
		...
		get_template_part('template-parts/components/hero-page', null, [
			'heading'     => get_field('nis_hero_heading') ?: '',
			'description' => get_field('nis_hero_subheading') ?: '',
	...
	<?php endif; ?>
		...
		<!-- 3. Postup testování -->
		<?php
		$postup_heading = get_field('nis_postup_heading') ?: '';
		$postup_text    = get_field('nis_postup_text') ?: '';
		$kroky          = get_field('nis_postup_kroky') ?: [];
		?>
		<?php if ( get_field('nis_postup_zobrazit') !== false && ( $postup_heading || $postup_text || ! empty( $kroky ) ) ) : ?>
		...
		<!-- 4. Co získáte / Pro koho -->
		<?php
		$ziskate_heading   = get_field('nis_ziskate_heading') ?: '';
		$ziskate_text      = get_field('nis_ziskate_text') ?: '';
		$ziskate_seznam    = get_field('nis_ziskate_seznam') ?: [];
		$prokoho_heading   = get_field('nis_prokoho_heading') ?: '';
		$prokoho_text      = get_field('nis_prokoho_text') ?: '';
		$prokoho_seznam    = get_field('nis_prokoho_seznam') ?: [];
		$benefity_cta_text = get_field('nis_benefity_cta_text') ?: '';
		...
		$show_benefity = get_field('nis_benefity_zobrazit') !== false && ( $has_ziskate || $has_prokoho );
		?>
	...
	<!-- 5. Banner -->
	<?php
	$banner_heading  = get_field('nis_banner_heading') ?: '';
	$banner_text     = get_field('nis_banner_text') ?: '';
	$banner_btn_text = get_field('nis_banner_btn_text') ?: '';
	...
	$show_banner     = get_field('nis_banner_zobrazit') !== false && ( $banner_heading || $banner_text || $banner_btn_text || $banner_img_id );
	?>
	<?php if ( $show_banner ) : ?>
	...
	<?php if (get_field('nis_formular_zobrazit') !== false) : ?>
		<?php
		$form_heading = get_field('nis_formular_heading') ?: '';
		$form_text    = get_field('nis_formular_text') ?: '';
		?>
		<section class="xevos-section" id="formular">
			<div class="xevos-section__container">
				...
				<?php get_template_part('template-parts/components/inquiry-form', null, ['prefix' => 'nis']); ?>
			</div>
		</section>
	<?php endif; ?>
