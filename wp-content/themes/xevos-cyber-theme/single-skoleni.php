...
?>
	...
	<main id="main" class="xevos-main xevos-skoleni-detail">
		<!-- Background layers -->
		...
		$is_free_hero = get_field('registrace_zdarma');
		if ($is_free_hero) {
		...
		<!-- Pattern overlay from "Pro koho" to footer -->
		<div class="xevos-skoleni-pattern-wrap">
							...
							<div class="xevos-skoleni-content-cols__col">
								...
								<ul class="xevos-osnova-list">
									<?php foreach ($osnova as $o) : ?>
										<li><?php echo wp_kses($o['bod'] ?? '', ['strong' => []]); ?></li>
									<?php endforeach; ?>
								</ul>
							</div>
						<?php endif; ?>
	     ...
	     ============================================================ -->
			<div class="xevos-glow-wrap xevos-skoleni-recenze-wrap">
				<div class="xevos-glow-blob xevos-skoleni-recenze-glow" aria-hidden="true"></div>
	     ...
	     ============================================================ -->
			<?php
			if ($formular !== '0') :
				$is_free = get_field('registrace_zdarma');
				...
				<section class="xevos-section" id="objednavka">
					<div class="xevos-section__container">
						<div class="xevos-skoleni-section-header">
							<h2><?php echo $is_free ? 'Registrace zdarma' : 'Objednat školení'; ?></h2>
						...
						<form class="xevos-order-section" method="post" action="<?php echo $is_free ? '' : ''; ?>" id="xevos-order-form" data-free="<?php echo $is_free ? '1' : '0'; ?>">
							...
							<div class="xevos-order-summary">
								...
								<button type="submit" class="xevos-btn xevos-btn--primary" id="xevos-order-submit">
									...
									<?php echo $is_free ? 'Registrovat se zdarma' : 'Závazně objednat'; ?>
								</button>
		...
		</div><!-- /.xevos-skoleni-pattern-wrap -->
