...
<title>Nová poptávka testování</title>
<!--[if mso]>
...
<tr>
  <td style="background-color:#0f172a;padding:16px 40px;">
    <p style="margin:0;font-size:18px;font-weight:700;color:#ffffff;font-family:Arial,Helvetica,sans-serif;">Nová poptávka testování</p>
    <?php if ( ! empty( $email_data['druh_testu'] ) ) : ?>
    <p style="margin:4px 0 0;font-size:14px;color:#F527AA;font-family:Arial,Helvetica,sans-serif;font-weight:600;"><?php echo esc_html( $email_data['druh_testu'] ); ?></p>
    <?php endif; ?>
  </td>
</tr>
