...
<title>Žádost o pozvánku přijata</title>
<!--[if mso]>
...
<tr>
  <td class="body-cell" style="padding:40px;background-color:#111827;">
    ...
    <h1 style="margin:0 0 8px;font-size:24px;font-weight:700;color:#ffffff;font-family:Arial,Helvetica,sans-serif;line-height:1.3;">Žádost o pozvánku přijata</h1>
    ...
    <p style="margin:0 0 28px;font-size:15px;color:#cbd5e1;font-family:Arial,Helvetica,sans-serif;line-height:1.6;">Děkujeme za Váš zájem. Vaše žádost o pozvánku na školení byla přijata.</p>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 28px;">
      <tr>
        <td style="background-color:#0f172a;border:1px solid #1e293b;border-left:4px solid #F527AA;padding:20px 24px;">
          ...
          <p style="margin:0;font-size:14px;color:#94a3b8;font-family:Arial,Helvetica,sans-serif;">
            <strong style="color:#64748b;">Termín:</strong>
            <span style="color:#e2e8f0;font-weight:600;"> <?php echo esc_html( $email_data['termin'] ); ?></span>
          </p>
          <?php endif; ?>
        </td>
      </tr>
    ...
    <p style="margin:0 0 28px;font-size:15px;color:#cbd5e1;font-family:Arial,Helvetica,sans-serif;line-height:1.6;">Kapacita akce je omezená. Zkontrolujeme dostupnost a co nejdříve se Vám ozveme s potvrzením.</p>
