...
<tr>
  <td class="body-cell" style="padding:40px;background-color:#111827;">
    ...
    <h1 style="margin:0 0 8px;font-size:24px;font-weight:700;color:#ffffff;font-family:Arial,Helvetica,sans-serif;line-height:1.3;">Zrušení účasti</h1>
    ...
    <p style="margin:0 0 28px;font-size:15px;color:#cbd5e1;font-family:Arial,Helvetica,sans-serif;line-height:1.6;">
      Vaše účast na školení <strong style="color:#ffffff;"><?php echo esc_html( $email_data['nazev_skoleni'] ?? '' ); ?></strong>
      <?php if ( ! empty( $email_data['termin'] ) ) : ?>
        (<?php echo esc_html( $email_data['termin'] ); ?>)
      <?php endif; ?>
      byla zrušena.
    </p>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 28px;">
      <tr>
        <td style="background-color:#052e16;border:1px solid #166534;padding:16px 20px;">
          <p style="margin:0;font-size:15px;font-weight:700;color:#4ade80;font-family:Arial,Helvetica,sans-serif;">&#10003; Refundace <?php echo esc_html( $email_data['cena'] ?? '' ); ?> Kč byla zahájena a bude zpracována do 5–10 pracovních dnů.</p>
        </td>
      </tr>
    </table>
    <?php endif; ?>

    <p style="margin:0 0 16px;font-size:15px;color:#cbd5e1;font-family:Arial,Helvetica,sans-serif;line-height:1.6;">Pokud máte jakékoli dotazy ohledně zrušení nebo refundace, neváhejte nás kontaktovat.</p>

    <?php if ( ! empty( $email_data['skoleni_url'] ) ) : ?>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 20px;">
      <tr>
        <td>
          <a href="<?php echo esc_url( $email_data['skoleni_url'] ); ?>" style="font-size:13px;color:#94a3b8;text-decoration:none;font-family:Arial,Helvetica,sans-serif;">&#8592; Zpět na stránku školení</a>
        </td>
      </tr>
    </table>
    <?php endif; ?>

    <p style="margin:0;font-size:13px;color:#4b5563;font-family:Arial,Helvetica,sans-serif;line-height:1.6;">Kontakt: <a href="mailto:<?php echo esc_attr( $email_data['kontakt_email'] ?? 'hello@xevos.eu' ); ?>" style="color:#F527AA;text-decoration:none;"><?php echo esc_html( $email_data['kontakt_email'] ?? 'hello@xevos.eu' ); ?></a></p>
