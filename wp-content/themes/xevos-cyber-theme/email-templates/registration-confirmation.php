...
<tr><td style="background-color:#0f172a;padding:30px 40px;text-align:center;">
	<h1 style="color:#ffffff;margin:0;font-size:22px;">Registrace potvrzena</h1>
</td></tr>

<tr><td style="padding:40px;">
	<p style="font-size:16px;color:#333;margin:0 0 20px;">Dobrý den, <?php echo esc_html( $email_data['jmeno'] ?? '' ); ?>,</p>
	<p style="font-size:14px;color:#555;margin:0 0 20px;">Vaše registrace na školení byla úspěšně dokončena.</p>
	...
	<h3 style="font-size:15px;color:#333;margin:20px 0 10px;">Harmonogram dne</h3>
	<table role="presentation" width="100%" cellpadding="6" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:4px;font-size:14px;">
		<?php foreach ( $email_data['harmonogram'] as $h ) : ?>
		<tr><td style="color:#64748b;width:100px;"><?php echo esc_html( $h['cas'] ?? '' ); ?></td><td style="color:#333;"><?php echo esc_html( $h['aktivita'] ?? '' ); ?></td></tr>
		<?php endforeach; ?>
	</table>
	<?php endif; ?>
