...
<tr>
  <td style="background-color:#0f172a;padding:16px 40px;">
    <p style="margin:0;font-size:11px;color:#64748b;font-family:Arial,Helvetica,sans-serif;text-transform:uppercase;letter-spacing:1px;"><?php echo esc_html( $email_data['typ'] ?? 'Nová registrace' ); ?></p>
    <p style="margin:4px 0 0;font-size:18px;font-weight:700;color:#ffffff;font-family:Arial,Helvetica,sans-serif;"><?php echo esc_html( $email_data['nazev_skoleni'] ?? 'Školení' ); ?></p>
    <?php if ( ! empty( $email_data['termin'] ) ) : ?>
    <p style="margin:4px 0 0;font-size:14px;color:#F527AA;font-family:Arial,Helvetica,sans-serif;font-weight:600;"><?php echo esc_html( $email_data['termin'] ); ?></p>
    <?php endif; ?>
  </td>
</tr>
  ...
  <td class="body-cell" style="padding:32px 40px;background-color:#111827;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #1e293b;">
      <tr style="background-color:#0f172a;">
        <td style="padding:10px 16px;font-size:13px;color:#64748b;font-family:Arial,Helvetica,sans-serif;width:140px;border-bottom:1px solid #1e293b;">Jméno:</td>
      ...
      <tr style="background-color:#0f172a;">
        <td style="padding:10px 16px;font-size:13px;color:#64748b;font-family:Arial,Helvetica,sans-serif;">Typ:</td>
        <td style="padding:10px 16px;font-size:14px;font-family:Arial,Helvetica,sans-serif;">
          <span style="display:inline;background-color:<?php echo ( $email_data['typ'] ?? '' ) === 'Žádost o pozvánku' ? '#78350f' : '#4c1d95'; ?>;color:#ffffff;padding:3px 10px;font-size:12px;font-weight:700;font-family:Arial,Helvetica,sans-serif;">
            <?php echo esc_html( $email_data['typ'] ?? 'Registrace zdarma' ); ?>
          </span>
        </td>
      </tr>
    </table>
