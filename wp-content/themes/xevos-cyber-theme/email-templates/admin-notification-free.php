...
<tr><td style="background-color:#0f172a;padding:24px 40px;text-align:center;">
	<h1 style="color:#ffffff;margin:0;font-size:20px;"><?php echo esc_html( $email_data['typ'] ?? 'Nová registrace' ); ?></h1>
</td></tr>

<tr><td style="padding:30px 40px;">
	<table role="presentation" width="100%" cellpadding="6" cellspacing="0" style="font-size:14px;">
		<tr><td style="color:#64748b;width:140px;">Typ:</td><td style="color:#333;font-weight:bold;"><?php echo esc_html( $email_data['typ'] ?? '' ); ?></td></tr>
