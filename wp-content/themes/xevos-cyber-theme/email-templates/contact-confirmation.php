...
<tr>
  <td class="body-cell" style="padding:40px;background-color:#111827;">
    ...
    <h1 style="margin:0 0 8px;font-size:24px;font-weight:700;color:#ffffff;font-family:Arial,Helvetica,sans-serif;line-height:1.3;">Děkujeme za Vaši zprávu</h1>
    ...
    <p style="margin:0 0 28px;font-size:15px;color:#cbd5e1;font-family:Arial,Helvetica,sans-serif;line-height:1.6;">Vaše zpráva byla úspěšně doručena. Ozveme se Vám co nejdříve.</p>

    <!-- INFO BOX -->
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 28px;">
      <tr>
        <td style="background-color:#0f172a;border:1px solid #1e293b;padding:16px 24px;text-align:center;">
          <p style="margin:0;font-size:14px;color:#94a3b8;font-family:Arial,Helvetica,sans-serif;">Obvykle odpovídáme do <strong style="color:#e2e8f0;">24 hodin</strong> v pracovní dny.</p>
        </td>
      </tr>
    </table>

    <p style="margin:0;font-size:13px;color:#4b5563;font-family:Arial,Helvetica,sans-serif;line-height:1.6;">Pokud je Vaše záležitost urgentní, kontaktujte nás přímo na <a href="mailto:<?php echo esc_attr( $email_data['kontakt_email'] ?? 'hello@xevos.eu' ); ?>" style="color:#F527AA;text-decoration:none;"><?php echo esc_html( $email_data['kontakt_email'] ?? 'hello@xevos.eu' ); ?></a> nebo telefonicky na <a href="tel:+420591140315" style="color:#94a3b8;text-decoration:none;">+420 591 140 315</a>.</p>
