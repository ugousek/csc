...
<div class="<?php echo esc_attr($wrap_class); ?>">
	<?php if ($adresa) : ?>
		<div class="xevos-contact-info__item">
			<span class="xevos-contact-info__icon">
				<img src="<?= get_template_directory_uri(); ?>/assets/img/global/pin-drop.svg" alt="" class="xevos-kontakt__icon">
			</span>
	...
	<?php if ($telefon) : ?>
		<div class="xevos-contact-info__item">
			<span class="xevos-contact-info__icon">
				<img src="<?= get_template_directory_uri(); ?>/assets/img/global/phone.svg" alt="" class="xevos-kontakt__icon">
			</span>
	...
	<?php if ($email) : ?>
		<div class="xevos-contact-info__item">
			<span class="xevos-contact-info__icon">
				<img src="<?= get_template_directory_uri(); ?>/assets/img/global/mail.svg" alt="" class="xevos-kontakt__icon">
			</span>
