...
get_template_part( 'template-parts/components/hero-page', null, [
	'heading'     => get_field( 'eventy_heading' ) ?: 'Aktuální eventy a školení',
	'description' => get_field( 'eventy_popis_hero' ) ?: 'Workshopy, školení a odborné akce zaměřené na praktickou kybernetickou bezpečnost, aktuální hrozby a reálné scénáře z praxe.',
